<%@ Page Title="" Language="C#" MasterPageFile="~/masters/MasterPage.master" AutoEventWireup="true"
  CodeFile="TriggerStatus.aspx.cs" Inherits="TriggerStatus" %>
  ...
  <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <%-- <script type="text/javascript">
      ...
      <section class="content-header">
        ...
        <!-- <ol class="breadcrumb">
            <li><a href="TriggerStatus.aspx"><i class="fa fa-home"></i> Home</a></li>
            <li  class="active">Trigger Status</li>
             </ol>
            <br />-->
      </section>
