<%@ Page Title="" Language="C#" MasterPageFile="~/masters/MasterPage.master" AutoEventWireup="true"
  CodeFile="organization_list.aspx.cs" Inherits="organization_list" %>
    ...
    <%-- <script type="text/javascript">
      ...
      <section class="content-header">
        ...
        <!-- <ol class="breadcrumb">
            ...
            <li  class="active">List of Organizations</li>
             </ol> -->
                      ...
                      <tr>
                        ...
                        <td style="text-align:right">
                          ...
                          <button class="btn btn-primary" id="btnAddUser"
                            onclick="javascript:location.href='organization_ui.aspx?type=e&id=0';">Add New
                            Organzation</button>
                        </td>
                      </tr>
                    </table>
