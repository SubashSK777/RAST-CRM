<%@ Page Title="" Language="C#" MasterPageFile="~/masters/MasterPage.master" AutoEventWireup="true" CodeFile="OrganizationAlertCount.aspx.cs" Inherits="OrganizationAlertCount" %>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <section class="content-header">
          <h1>
          Organization Alert-Count Report
          </h1>
          <ol class="breadcrumb">
            <li><a href="map.aspx"><i class="fa fa-home"></i> Home</a></li>
              <li><a>Organization Alert-Count Report</a></li>
             </ol>
            <br />
        </section>
             ...
             <div class="box-body">
                 <div class="row">
                   ...
                   <div class="form-group pull-left">
                     <button id="btnDataReport" class="btn btn-primary" onclick="javascript:fnViewReport();" >View Report</button>
                   ...
                   <div class="form-group pull-right">
                     <button id="btnData" class="btn btn-primary" onclick="javascript:fnViewChartData();" >View Data</button>
   ...
   function (start, end) {
       ...
       document.getElementById("hidEndDate").value = dtEndDate;
        ...
        function fnViewReport() {
            ...
            fnGetOrganizationAlertCount(dtStartDate, dtEndDate);
        }

        function fnGetOrganizationAlertCount(dtStartDate, dtEndDate) {
            ...
            $(document).ready(function () {
                $.ajax({
                    type: 'GET',
                    url: '/services/alertcount_report.aspx?id=3&startdate=' + dtStartDate + '&enddate=' + dtEndDate,
                    success: function (data) {
                        ...
                        if (dv_chart_data.length > 0) {
                            ...
                            for (var i = 0; i < dv_chart_data.length; i++) {
                                ...
                                arrXAxis.push(dv_chart_data[i].s_OrganizationName);
        ...
        function fnShowChartData() {
            ...
            $.ajax({
                type: 'GET',
                async: false,
                url: '/services/alertcount_report.aspx?id=6&startdate=' + dtStartDate + '&enddate=' + dtEndDate,
                success: function (data) {
