    ...
    DateRangePicker.prototype = {
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                var dates = this.ranges[label]; ///Ragu 29 Nov 2019
                if (dates == null)
                {
                    this.container.find('input[name=daterangepicker_start]').val(this.oldStartDate.format(this.format));
                    this.container.find('input[name=daterangepicker_end]').val(this.oldEndDate.format(this.format));
                }
                else
                {
